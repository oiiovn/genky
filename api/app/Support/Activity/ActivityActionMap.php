...
class ActivityActionMap
{
    ...
    protected static function rules(): array
    {
        return [
            ...
            ['methods' => ['POST'], 'pattern' => '#^marketing/review-campaigns/\d+/activate$#', 'action' => 'update', 'label' => 'Kích hoạt chiến dịch đánh giá', 'object' => 'Chiến dịch marketing'],
            ['methods' => ['POST'], 'pattern' => '#^marketing/reviews$#', 'action' => 'create', 'label' => 'Thêm đánh giá marketing', 'input' => 'order_code', 'fallback' => 'Đánh giá'],
            ['methods' => ['POST'], 'pattern' => '#^marketing/reviews/\d+/verify$#', 'action' => 'update', 'label' => 'Xác minh đánh giá marketing', 'object' => 'Đánh giá'],
            ['methods' => ['POST'], 'pattern' => '#^marketing/reviews/\d+/reject$#', 'action' => 'update', 'label' => 'Từ chối đánh giá marketing', 'input' => 'reason', 'fallback' => 'Đánh giá'],
            ['methods' => ['POST'], 'pattern' => '#^marketing/reviews/\d+/issue-reward$#', 'action' => 'create', 'label' => 'Cấp mã quà marketing', 'object' => 'Mã quà'],
            ['methods' => ['POST'], 'pattern' => '#^marketing/reward-codes/check$#', 'action' => 'view', 'label' => 'Kiểm tra mã quà', 'input' => 'code', 'fallback' => 'Mã quà'],
            ['methods' => ['POST'], 'pattern' => '#^marketing/reward-codes/\d+/redeem$#', 'action' => 'update', 'label' => 'Đổi mã quà', 'object' => 'Mã quà'],
            ['methods' => ['POST'], 'pattern' => '#^marketing/channels$#', 'action' => 'create', 'label' => 'Thêm kênh bán hàng', 'input' => 'name', 'fallback' => 'Kênh'],
            ['methods' => ['PATCH'], 'pattern' => '#^marketing/channels/\d+$#', 'action' => 'update', 'label' => 'Sửa kênh bán hàng', 'object' => 'Kênh'],
            ['methods' => ['DELETE'], 'pattern' => '#^marketing/channels/\d+$#', 'action' => 'delete', 'label' => 'Xoá kênh bán hàng', 'object' => 'Kênh'],
            ['methods' => ['POST'], 'pattern' => '#^marketing/channels/reorder$#', 'action' => 'update', 'label' => 'Sắp xếp kênh bán hàng', 'object' => 'Kênh'],
            ['methods' => ['POST'], 'pattern' => '#^marketing/channels/seed-defaults$#', 'action' => 'create', 'label' => 'Khởi tạo kênh bán hàng mặc định', 'object' => 'Kênh'],
