...
export function buildReviewBoostDemoOverview(
  ...
  return {
    ...
    daily: [
      { date: "2026-08-01", label: "01", count: 62 },
      { date: "2026-08-02", label: "02", count: 71 },
      { date: "2026-08-03", label: "03", count: 68 },
      { date: "2026-08-04", label: "04", count: 84 },
      { date: "2026-08-05", label: "05", count: 79 },
      { date: "2026-08-06", label: "06", count: 91 },
      { date: "2026-08-07", label: "07", count: 88 },
      { date: "2026-08-08", label: "08", count: 102 },
      { date: "2026-08-09", label: "09", count: 128 },
      { date: "2026-08-10", label: "10", count: 110 },
      { date: "2026-08-11", label: "11", count: 96 },
      { date: "2026-08-12", label: "12", count: 104 },
      { date: "2026-08-13", label: "13", count: 98 },
    ],
    channels: [
